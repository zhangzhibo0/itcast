package com.itheima.day05Throwable.demo02Throw;
/*
    throw关键字
    作用:
...
public class Demo01Throw {
    ...
    参数:
        int[] arr
        int index
    在工作中我们首先必须对方法传递过来的参数进行合法性校验
    如果参数不合法,那么我们就必须使用抛出异常的方式，告知方法的条用着，传递的参数有问题
    注意:
        NullPointerExceptio是一个运行期异常，不用处理,默认交给JVM处理
 */
    public static int getElement(int[] arr, int index) {
         ...
         */
        if(arr == null){
            throw new NullPointerException("传递数组值是空");
        }
